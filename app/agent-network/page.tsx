    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-display">Deploy Agent</Button>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-code-foreground font-mono">847</p>
              </div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {filteredAgents.map((agent, index) => (
                  ...
                  >
                    <td className="py-3 px-4 text-sm text-code-foreground font-mono">{agent.id}</td>
                    ...
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-code-foreground font-mono">{agent.lastSeen}</span>
                      </div>
                    </td>
                    <td className="py-3 px-4 text-sm text-code-foreground font-mono">{agent.missions}</td>
                    <td className="py-3 px-4">
                      <span
