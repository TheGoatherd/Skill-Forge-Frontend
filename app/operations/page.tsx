    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex gap-2">
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-display">New Operation</Button>
          <Button className="bg-primary hover:bg-primary/90 text-primary-foreground font-display">Mission Brief</Button>
        </div>
      </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-code-foreground font-mono">23</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-code-foreground font-mono">156</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-red-500 text-code-foreground font-mono">2</p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-code-foreground font-mono">94%</p>
              </div>
            ...
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-xs text-code-foreground font-mono">{operation.id}</p>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-xs">
                  ...
                  <span className="text-code-foreground font-mono">{operation.progress}%</span>
                </div>
          ...
          <Card className="bg-neutral-900 border-neutral-700 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <p className="text-sm text-code-foreground font-mono">{selectedOperation.id}</p>
              </div>
              <Button
                variant="ghost"
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-code-foreground font-mono">{selectedOperation.estimatedCompletion}</span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-code-foreground font-mono">{selectedOperation.progress}%</span>
                      </div>
